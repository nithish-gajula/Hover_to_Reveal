...
//document.getElementById('mySound').autoplay;
var audio = new Audio('images/L_B_M.mp3');
...
document.getElementById("name").addEventListener("keyup", function() {
  ...
  if(value=="1" ){
    ...
    const imageUrl = `images/image1_org.jpg`;
    const hoverUrl = "images/image1_anm.jpg";
  ...
  if(value=="2"){
    const myImage = document.getElementById("myImage");
    const imageUrl = `images/image2_org.jpg`;
    const hoverUrl = "images/image2_anm.jpg";
    myImage.setAttribute("src", imageUrl);
    myImage.setAttribute("data-hover", hoverUrl);
    new Scene();
    canvas.style.display="";
  ...
  if(value=="3"){
    const myImage = document.getElementById("myImage");
    const imageUrl = `images/image3_org.jpg`;
    const hoverUrl = "images/image3_anm.jpg";
    myImage.setAttribute("src", imageUrl);
    myImage.setAttribute("data-hover", hoverUrl);
    new Scene();
    canvas.style.display="";
  ...
  if(value=="4"){
    const myImage = document.getElementById("myImage");
    const imageUrl = `images/image4_org.jpg`;
    const hoverUrl = "images/image4_anm.jpg";
    myImage.setAttribute("src", imageUrl);
    myImage.setAttribute("data-hover", hoverUrl);
    new Scene();
    canvas.style.display="";
  ...
  if(value=="5"){
    const myImage = document.getElementById("myImage");
    const imageUrl = `images/image5_org.jpg`;
    const hoverUrl = "images/image5_anm.jpg";
    myImage.setAttribute("src", imageUrl);
    myImage.setAttribute("data-hover", hoverUrl);
    new Scene();
    canvas.style.display="";
  ...
  if(value=="6"){
    const myImage = document.getElementById("myImage");
    const imageUrl = `images/image6_org.jpg`;
    const hoverUrl = "images/image6_anm.jpg";
    myImage.setAttribute("src", imageUrl);
    myImage.setAttribute("data-hover", hoverUrl);
    new Scene();
    canvas.style.display="";
  ...
  if(value=="7"){
    const myImage = document.getElementById("myImage");
    const imageUrl = `images/image7_org.jpg`;
    const hoverUrl = "images/image7_anm.jpg";
    myImage.setAttribute("src", imageUrl);
    myImage.setAttribute("data-hover", hoverUrl);
    new Scene();
    canvas.style.display="";
